package com.kd.cube.input;

public class Input
{
	/**
	 * Key Constant is come from LWJGL Keyboard class
	 */
	...
	public static final int BUTTON_LEFT = 0x00;
	public static final int BUTTON_RIGHT = 0x01;
	public static final int BUTTON_SCROLL = 2;
	...
	public static ArrayList<Integer> getkeys() {
		downKeys.removeAll(downKeys);
		for (int i = 0; i < NUM_KEYCODES; i++) {
			if (getKey(i) && !isClicked(i)) {
				downKeys.add(i);
				lastKeys.add(i);
			}else if (!getKey(i) && isClicked(i))
				removeKey(i);
		}
		if (downKeys.size() != 0)
			return downKeys;
